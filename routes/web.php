...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('employees/team', [PEmployeeController::class, 'addMember'])->name('employees.addMember');
    ...
    // Drive Files
    Route::get('drivefiles/{folder?}', [DriveFileController::class, 'index'])
    ->where('folder', '(.*)')
    ->name('drivefiles.MyFiles');
    Route::post('/drivefiles/create', [DriveFileController::class, 'createFolder'])->name('folder.create');
