...
<div class="main-content">
    ...
    <div class="content-header">
        <div class="d-flex align-items-center" style="position:relative;z-index:1;">
            ...
            <div>
                <h1 class="content-title mb-1">Add New Employee</h1>
                <p class="content-subtitle">Set up a new employee info</p>
            </div>
        </div>
    </div>
    ...
    <div class="cu-layout">
        ...
        <div class="cu-info-panel">
            ...
            <div class="cu-info-body">
                ...
                <div class="cu-preview-name" id="previewName">New Employee</div>
                ...
                <div class="cu-meta-row">
                    ...
                    <span>Salary&nbsp;<strong id="previewBudget">—</strong></span>
                </div>
            </div>
        </div>

        {{-- ── Right Form Sections ───────────────────────────── --}}
        <form action="{{ route('employees.store') }}" method="POST" id="createProjectForm">
            @csrf
            ...
            <div class="cu-sections">
                ...
                <div class="cu-section">
                    ...
                    <div class="cu-section-body">
                        <div class="cu-field">
                            <label for="name" class="cu-label">Employee Name<span style="color:#dc2626;">*</span></label>
                         ...
                         <div class="cu-field">
                            <label for="team" class="cu-label">Position <span style="color:#dc2626;">*</span></label>
                            <div class="cu-input-wrap">
                ...
                <div class="cu-section">
                    <div class="cu-section-header">
                        ...
                        <span class="cu-section-title">DOS (Date of Start) &amp; Basic Salary</span>
                    </div>
                    <div class="cu-section-body">
                ...
                <div class="cu-section">
                    <div class="cu-action-bar">
                        <a href="{{ route('employees.index') }}" class="cu-btn-cancel">Cancel</a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const budgetInput = document.getElementById('salary');
    ...
    var quill = new Quill('#quill-editor', {
        theme: 'snow',
        placeholder: 'Description for Employee ..',
        modules: {
            toolbar: [
