...
<style>
    ...
    .cu-chip-option input:checked + .cu-chip-label {
...
<div class="main-content">
    ...
    <div class="content-header">
        <div class="d-flex align-items-center" style="position:relative;z-index:1;">
            <a href="{{ route('employees.show', $employee) }}" class="me-3 text-decoration-none">
    ...
    @php
        ...
        $statusInfo = $statusMap[$employee->status] ?? $statusMap['not_started'];
    @endphp
    ...
    <div class="cu-layout">
        ...
        <div class="cu-info-panel">
            ...
            <div class="cu-info-body">
                <div class="cu-project-avatar" style="background:{{ $projectColor }};">
                    {{ strtoupper(substr($employee->name, 0, 1)) }}
                </div>
                <div class="cu-project-name">{{ $employee->name }}</div>
                ...
                <div class="cu-meta-row">
                    ...
                    <span>Start&nbsp;<strong>{{ \Carbon\Carbon::parse($employee->start_date)->format('M d, Y') }}</strong></span>
                </div>
                @endif
                ...
                <div class="cu-meta-row">
                    ...
                    <span>Due&nbsp;<strong>{{ \Carbon\Carbon::parse($employee->end_date)->format('M d, Y') }}</strong></span>
                </div>
                @endif
                ...
                <div class="cu-meta-row">
                    ...
                    <span>Budget&nbsp;<strong>${{ number_format($employee->budget, 0) }}</strong></span>
                </div>
                @endif

                <div class="cu-meta-row">
                    <i class="bi bi-clock-history"></i>
                    <span>Updated&nbsp;<strong>{{ $employee->updated_at->diffForHumans() }}</strong></span>
                </div>
        ...
        {{-- ── Right Form Sections ───────────────────────────── --}}
        <form action="{{ route('employees.update', $employee) }}" method="POST" id="editProjectForm">
            @csrf
            @method('PUT')
            ...
            <div class="cu-sections">
                    ...
                    <div class="cu-section-body">
                        ...
                        <div class="cu-field">
                            ...
                            <div class="cu-editor-wrap">
                                ...
                                <textarea name="description" id="description" style="display:none;">{{ old('description', $employee->description) }}</textarea>
                            </div>
                ...
                <div class="cu-section">
                    ...
                    <div class="cu-section-body">
                        ...
                        <div class="cu-field" style="margin-bottom:0; margin-top:12px;">
                            <label for="salary" class="cu-label">Basic Salary (RM)</label>
                            <div class="cu-input-wrap">
                                <i class="bi bi-currency-dollar"></i>
                                <input type="number"
                                       name="salary"
                                       id="salary"
                                       class="cu-input {{ $errors->has('salary') ? 'is-invalid' : '' }}"
                        ...
                        <div class="cu-field" style="margin-bottom:0; margin-top:12px;">
                            <label for="allowance" class="cu-label">Allowance (RM)</label>
                            <div class="cu-input-wrap">
                                <i class="bi bi-currency-dollar"></i>
                                <input type="number"
                                       name="allowance"
                                       id="allowance"
                                       class="cu-input {{ $errors->has('allowance') ? 'is-invalid' : '' }}"
                ...
                <div class="cu-section">
                    <div class="cu-action-bar">
                        <a href="{{ route('employees.show', $employee) }}" class="cu-btn-cancel">Cancel</a>
    ...
    <div class="cu-section cu-danger-section" style="margin-top:10px; border-color:#fecaca;">
        ...
        <div class="cu-section-body">
            <div class="cu-danger-text">
                <h6>Delete this employee from the list</h6>
                <p>Permanently removes the employee and all the data. This cannot be undone.</p>
            </div>
            <form action="{{ route('employees.destroy', $employee) }}" method="POST" id="deleteForm">
                @csrf
                @method('DELETE')
