...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/img/check-mark.png') }}" type="image/x-icon">
...
<div class="lc-wrap">
    <div class="lc-app-tag"><i class="bi bi-clipboard2-check-fill"></i> &nbsp;Dashboard</div>

    <div class="lc-card">
        <div class="lc-header">
            <div class="lc-logo"><i class="bi bi-clipboard2-check-fill"></i></div>
            <h1 class="lc-title">Please Register</h1>
            <p class="lc-sub">To Create new Account</p>
        </div>
        ...
        <div class="lc-body">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="lc-field">
                    <label for="email" class="lc-label">Name<span style="color:#dc2626;">*</span></label>
                    <div class="lc-input-wrap">
                        <i class="bi bi-person-add lc-input-icon"></i>
                        <input type="string" id="name" name="name"
                               class="lc-input @error('email') is-invalid @enderror"
                               value="{{ old('name') }}"
                               placeholder="E.g. Nukman Samsuddin"
                               required autofocus autocomplete="name">
                    </div>
                    <br>

                <div class="lc-field">
                    <label for="email" class="lc-label">Email Address<span style="color:#dc2626;">*</span></label>
                    <div class="lc-input-wrap">
                ...
                <div class="lc-field">
                    <label for="role" class="lc-label">Role <span style="color:#dc2626;">*</span></label>
                    <div class="lc-input-wrap">
                        <i class="bi bi-person-badge-fill lc-input-icon"></i>
                        <select class="lc-input" id="role" name="role" required style="appearance: auto; padding-right: 2rem;">
                            <option value="" disabled selected>Role for this user</option>
                 ...
                 <div class="lc-field">
                    <label for="team" class="lc-label">Team Project <span style="color:#dc2626;">*</span></label>
                    <div class="lc-input-wrap">
                        <i class="bi bi-people-fill lc-input-icon"></i>
                        <select class="lc-input" id="team" name="team" required style="appearance: auto; padding-right: 2rem;">
        ...
        <div class="lc-footer">
            Developed by
            <a href="#" target="_blank">Nukman@LawanaCareSolution</a>
        </div>
    </div>
</div>
